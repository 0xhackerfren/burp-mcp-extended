...
enum class HistoryAccessType() {
    HTTP_HISTORY(), WEBSOCKET_HISTORY(), SITE_MAP();
}
        ...
        return suspendCoroutine { continuation ->
            SwingUtilities.invokeLater {
                val historyTypeName = when (accessType) {
                    ...
                    HistoryAccessType.SITE_MAP -> "site map"
                }
                ...
                when (result) {
                    ...
                    1 -> {
                        when (accessType) {
                            ...
                            HistoryAccessType.SITE_MAP -> config.alwaysAllowSiteMap = true
                        }
                        continuation.resume(true)
                    }
...
object HistoryAccessSecurity {
    ...
    suspend fun checkHistoryAccessPermission(
        ...
        val isAlwaysAllowed = when (accessType) {
            ...
            HistoryAccessType.SITE_MAP -> config.alwaysAllowSiteMap
        }
